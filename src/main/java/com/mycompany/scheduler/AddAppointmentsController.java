...
public class AddAppointmentsController {
    ...
    */
    ...
    public void initialize(){
        ...
        appointmentTF.setText(Integer.toString(appointments.getNewAppointmentID()));
        setContactBox();
        setCustomerBox();
        setTimeBoxes();
        setUserBox();
    ...
    */
    ...
    public void setCustomerBox(){
     ...
     /**
    *Sets the Users into the user Combo box 
    ...
    */
    ...
    public void setUserBox(){
        ...
        userCB.setItems(currentUser.getallUsers());
        
        userCB.setConverter(new StringConverter<Users>(){
            @Override
            ...
            @Override
            public Users fromString(String arg0) {
                throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
            }
    ...
    */
    ...
    public Boolean vaildate() throws IOException{
        ...
        if(titleTF.getText().isBlank()){
            ...
            if(emptyCBMessage.isBlank()){
            
                emptyCBMessage = "Title";
            
            }
            else{
                
                 emptyCBMessage = emptyCBMessage + ", Title";
            }     
        }
        ...
        if(descTF.getText().isBlank()){
            ...
            if(emptyCBMessage.isBlank()){
                ...
                emptyCBMessage = "Description";
            
            }
            
            else{
                
                 emptyCBMessage = emptyCBMessage + ", Description";
            }
        }
        if(typeTF.getText().isBlank()){
            ...
            if(emptyCBMessage.isBlank()){
                ...
                emptyCBMessage = "Type";
                 ...
                 emptyCBMessage = emptyCBMessage + ", Type";
            }
        }
        ...
        if(locationTF.getText().isBlank()){
            ...
            emptyCBMessage = "Location";
            
            }
            else{
                
                 emptyCBMessage = emptyCBMessage+ ", Location";
            }
        ...
        if(contactCB.getValue() == null){
            ...
            if(emptyCBMessage.isBlank()){
                ...
                emptyCBMessage = "Please select a Contact";
            
            }
            else{
                
                 emptyCBMessage = emptyCBMessage+ ", Contact";
            }
        ...
        if(customerCB.getValue() == null){
            ...
            if(emptyCBMessage.isBlank()){
                ...
                emptyCBMessage = "Please select a Customer";
            
            }
            else{
                
                 emptyCBMessage = emptyCBMessage+ ", Customer";
            }
        ...
        if(userCB.getValue() == null){
            ...
            if(emptyCBMessage.isBlank()){
                ...
                emptyCBMessage = "Please select a User";
            
            }
            else{
                
                 emptyCBMessage = emptyCBMessage+ ", User";
            }
        ...
        if(emptyCBMessage.isBlank() && startEmptyDateTime.isBlank() && endEmptyDateTime.isBlank() && incorrectDateTime.isBlank() && getTime()){
    ...
    */
    ...
    public void displayAlert() throws IOException{
        ...
        String emptyAlert = "Please enter information for the following fields: " + emptyCBMessage;
        ...
        if(!emptyCBMessage.isBlank() && !startEmptyDateTime.isBlank() && !endEmptyDateTime.isBlank()&& !incorrectDateTime.isBlank()){

            alert.setContentText(emptyAlert + "\n\n" + startDateTimeAlert + "\n\n" + endtDateTimeAlert + "\n\n" + incorrectDateTime);
            alert.setHeight(450);
        }
        if(!emptyCBMessage.isBlank() && !startEmptyDateTime.isBlank() && !endEmptyDateTime.isBlank()){
        ...
        else if(!emptyCBMessage.isBlank() && !startEmptyDateTime.isBlank() &&  !incorrectDateTime.isBlank()){

            alert.setContentText(emptyAlert + "\n\n" + startDateTimeAlert + "\n\n" + incorrectDateTime);
            alert.setHeight(350);

        }
        else if(!emptyCBMessage.isBlank() && !endEmptyDateTime.isBlank() && !incorrectDateTime.isBlank()){
        ...
        else if(!emptyCBMessage.isBlank() && !startEmptyDateTime.isBlank()){

            alert.setContentText(emptyAlert + "\n\n" + startDateTimeAlert);
            alert.setHeight(280);

        }
        else if(!emptyCBMessage.isBlank() && !endEmptyDateTime.isBlank()){
        ...
        else if(!emptyCBMessage.isBlank()){
    ...
    */
    ...
    public void addAppointment() throws IOException{
        ...
        if(vaildate()){
            ...
            appointments.addAppointment(Integer.parseInt(appointmentTF.getText()), titleTF.getText(), descTF.getText(), locationTF.getText(), typeTF.getText(), StartDateTimeUTC, endDateTimeUTC,currentUser.getUser_Name(),currentUser.getUser_Name(),customerCB.getValue().getCustomer_ID(),userCB.getValue().getUser_ID(), contactCB.getValue().getContact_ID()) ;
